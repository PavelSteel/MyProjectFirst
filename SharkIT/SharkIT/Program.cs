...
class SarkItFormTester : Form
{
    ...
    (object sender, TreeViewEventArgs e)
    {
        ...
        else if (e.Node.Text == "TabControl")
        {
            ...
            TabPage tabPage1 = new TabPage("Пресс");
            PictureBox pictureBox1 = new PictureBox();
            pictureBox1.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBox1.Image = new Bitmap("C:\\Users\\missk\\Desktop\\MyProject C#\\Lesson.Form\\image\\1.jpg");
            ...
            labelV.Text = "Пресс очень сложно накачать и поддерживать в форме!";
            tabPage1.Controls.Add(labelV);
            tabControl1.TabPages.Add(tabPage1);

            TabPage tabPage2 = new TabPage("Сиси");
            PictureBox pictureBox2 = new PictureBox();
            pictureBox2.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBox2.Image = new Bitmap("C:\\Users\\missk\\Desktop\\MyProject C#\\Lesson.Form\\image\\2.png");
            pictureBox2.Size = new Size(300, 200);
            tabPage2.Controls.Add(pictureBox2);
            Label labelС = new Label();
            labelС.Top = 200;
            labelС.Size = new Size(300, 50);
            labelС.Text = "Красивая грудь - неотъемлемая часть красивой девушки!";
            tabPage2.Controls.Add(labelС);
            tabControl1.TabPages.Add(tabPage2);

            TabPage tabPage3 = new TabPage("Попка");
            PictureBox pictureBox3 = new PictureBox();
            pictureBox3.SizeMode = PictureBoxSizeMode.StretchImage;
            pictureBox3.Image = new Bitmap("C:\\Users\\missk\\Desktop\\MyProject C#\\Lesson.Form\\image\\3.png");
            pictureBox3.Size = new Size(300, 200);
            tabPage3.Controls.Add(pictureBox3);
            Label labelT = new Label();
            labelT.Top = 200;
            labelT.Size = new Size(300, 50);
            labelT.Text = "Накаченная попка сведет с ума любого мужчину!";
        ...
        else if (e.Node.Text == "PictureBox")
        {
            ...
            PictureBox pictureBox1 = new PictureBox();
            pictureBox1.Image = new Bitmap("C:\\Users\\missk\\Desktop\\MyProject C#\\Lesson.Form\\image\\mid_176256_4524.jpg");
        ...
        else if (e.Node.Text == "ToolBar")
        {
            ...
            imageList1.Images.Add(new Bitmap("C:\\Users\\missk\\Desktop\\MyProject C#\\Lesson.Form\\image\\1.jpg"));
            imageList1.Images.Add(new Bitmap("C:\\Users\\missk\\Desktop\\MyProject C#\\Lesson.Form\\image\\2.png"));
            imageList1.Images.Add(new Bitmap("C:\\Users\\missk\\Desktop\\MyProject C#\\Lesson.Form\\image\\3.png"));
